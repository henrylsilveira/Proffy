                ...
                <fieldset>
                    ...
                    {scheduleItems.map((scheduleItems, index) => {
                        return (
                            ...
                            <Select name="week_day" label="Dia da semana" value={scheduleItems.week_day} onChange={e => setScheduleItemValue(index,'week_day', e.target.value)} options={[ 
                            ...
                            <Input name="to" label="As" type="time" value={scheduleItems.to} onChange={e => setScheduleItemValue(index,'to', e.target.value)} />
                    </div>
                        )
                    })}
                </fieldset>
